        ...
        <form className="form-horizontal" role="form" acceptCharset="utf-8" action={this.props.action} method="post">
          ...
          <div className="form-group">
            <div className="markdown editor">
              <input id="title" className="form-control" name="title" value={this.props.name} placeholder="Title..." />
            </div>
          </div>
          <div className="form-group">
            <div className="markdown editor">
              <textarea id="noteArea" className="form-control" name="noteArea" style={{display: 'none'}} value={this.props.note} />
            </div>
          </div>
          <div className="form-group">
            <div className="markdown editor">
